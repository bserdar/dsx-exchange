  ...
  systemMetadata:
    ...
    messages:
      ...
      heartbeatEchoBms:
        $ref: '#/components/messages/SystemHeartbeatEchoBmsMsg'
      hearbeatTimestampIntegration:
        $ref: '#/components/messages/SystemHearbeatTimestampIntegrationMsg'
      heartbeatEchoIntegration:
...
components:
  ...
  messages:
    ...
    SystemHearbeatTimestampIntegrationMsg:
      payload:
        $ref: '#/components/schemas/SystemHearbeatTimestampIntegrationMetadata'
  ...
  schemas:
    ...
    PhaseCurrentFields:
      ...
      description: >
        ...
        phase (A, B, or C). 3 metadata messages per meter, one per phase.
      required:
        - engUnit
        - phase
      properties:
    ...
    HeartbeatTimestampBmsFields:
      type: object
      description: >
        Required heartbeat. Written every 5 s. `scope` optionally identifies
        which MQTT topics this heartbeat covers.
      properties:
        pointType:
          type: string
    ...
    HearbeatTimestampIntegrationFields:
      ...
      properties:
        pointType:
          type: string
          enum: [HearbeatTimestampIntegration]
    ...
    SystemHearbeatTimestampIntegrationMetadata:
      allOf:
        ...
        - $ref: '#/components/schemas/HearbeatTimestampIntegrationFields'
      unevaluatedProperties: false
      ...
      properties:
        ...
        phase:
          ...
          description: >
            ...
            generic measurements on power-capable equipment.
        integration:
          type: string
          description: >
            Optional integration identifier. When present, this integration
